      ...
      <div className="mx-auto w-full max-w-3xl px-6 py-12">
        ...
        <section className="mt-8">
          ...
          <ol className="mt-4 space-y-6">
            <Step n={1} title="会員登録 → 拡張 ZIP をダウンロード">
              <p>
                先に会員登録 (無料) を済ませ、マイページから拡張のダウンロードに進んでください。
              </p>
            ...
            <Step n={2} title="拡張を Chrome に読み込む">
              ...
              <p className="mt-3 rounded-md bg-amber-50 p-3 text-xs text-amber-800">
                ⚠ 解凍フォルダを移動すると拡張 ID が変わってしまいます。読み込んだ後はフォルダを移動しないでください。
              </p>
            </Step>
            ...
            <Step n={4} title="「有効化」をクリック">
              <p>
                成功すると「有効化されました」と表示され、Pro 機能が解放されます。
                有効期限はステータス欄に表示されます。
              </p>
            </Step>
          </ol>
        ...
        <section className="mt-12 rounded-xl border border-amber-200 bg-amber-50/60 p-6">
          ...
          <ul className="mt-3 list-disc pl-5 text-sm text-amber-900 space-y-1">
            ...
            <li>期限が切れた場合は、招待者から新しいコードを共有してもらってください。</li>
        ...
        <section className="mt-12">
          <h2 className="text-xl font-bold text-zinc-900">Pro 機能でできること</h2>
